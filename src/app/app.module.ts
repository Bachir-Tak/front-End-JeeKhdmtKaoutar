...
import { AchatCommandeCreateComponent } from './view/achatCommandes/achat-commande-create/achat-commande-create.component';
import { AchatCommandeListComponent } from './view/achatCommandes/achat-commande-list/achat-commande-list.component';
import { HistoriqueAchatCreateComponent } from './view/historiqueAchats/historique-achat-create/historique-achat-create.component';
import { HistoriqueAchatListComponent } from './view/historiqueAchats/historique-achat-list/historique-achat-list.component';
...
import { CommandeProduitCreateComponent } from './view/commandeProduits/commande-produit-create/commande-produit-create.component';
import { CommandeProduitListComponent } from './view/commandeProduits/commande-produit-list/commande-produit-list.component';
import { RecapulatifAchatCreateComponent } from './view/recapulatifAchats/recapulatif-achat-create/recapulatif-achat-create.component';
import { RecapulatifAchatListComponent } from './view/recapulatifAchats/recapulatif-achat-list/recapulatif-achat-list.component';
